...
<html>
    ...
    <%
        ...
        ResultSet rs;
        String qur="select * from category where id= '"+cat_id+"'";
        rs = st.executeQuery(qur);
        if(rs.next()) {
        session.setAttribute("cat_id", rs.getString("id"));
    %>
    <body>
        ...
        <div class="container mt-3">
            <div class="row">
                ...
                <form class="col-md-12" method="post" action="category_image_form.jsp" enctype="multipart/form-data">
