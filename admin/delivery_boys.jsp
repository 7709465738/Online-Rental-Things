...
<html>
    ...
    <%
        ...
        ResultSet rs;
        String qur="select * from users where role=2 order by id DESC";
        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col-md-12 mb-3">
                    <h2 class="text-primary">Delivery Boys</h2>
                    <%@ include file="../partials/msgs.jsp" %>
                </div>
                <div class="row mb-3">
                    <div class="col-md-12">
                        <a href="delivery_boys_create.jsp" class="btn btn-primary">New Delivery boy</a>
                    </div>
                </div>
                <div class="col-md-12">
                        ...
                        <table class="table" id="datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-info" href="delivery_boys_edit.jsp?user_id=<%=rs.getString("id")%>">Edit</a>
                                    </td>
                                </tr>
                                <% } %>
                            </tbody>
