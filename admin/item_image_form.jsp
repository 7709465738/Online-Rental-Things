        ...
        <%            //Code to insert data in mysql database vegitem table
            try 
            {
                ...
                if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) 
                {
                    ...
                    File ff = new File("D:/Java/rent-thing/web/img/items/" + saveFile);
                    ...
                    String path = "items/" + saveFile;
                    String qur_add_img = "update product_items set image = '" + path + "' where id = '" + session.getAttribute("item_id") + "'";
