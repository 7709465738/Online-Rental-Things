        ...
        <%            //Code to insert data in mysql database vegitem table
            try {
                ...
                if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
                    ...
                    File ff = new File("D:/Java/rent-thing/web/img/packages/" + saveFile);
                    ...
                    String path = "packages/" + saveFile;
                    String qur_add_img = "update packages set image = '" + path + "' where id = '" + session.getAttribute("package_id") + "'";
